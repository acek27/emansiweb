        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li><a href="list_event.php"><i class="fa fa-desktop fa-fw">
                        <div class="icon-bg bg-pink"></div>
                    </i><span class="menu-title">LIST EVENT</span></a>
                    ...
                    <li class="active"><a href="about.php"><i class="fa fa-edit fa-fw">
            ...
            <div id="page-wrapper">
                ...
                <span style="margin-left: 10px"><h4>EMANSI adalah sistem untuk mempermudah mahasiswa dalam memanajemen acara</h4></span>
                <!--BEGIN FOOTER-->
                <div id="footer">
                    <div class="copyright">
