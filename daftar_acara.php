        ...
        <nav id="sidebar" role="navigation" data-step="2"
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="dashboard_guest.php"><i class="fa fa-tachometer fa-fw">
        ...
        <div id="page-wrapper">
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li><i class="fa fa-home"></i>&nbsp;<a href="dashboard_guest.php">Home</a>&nbsp;&nbsp;<i
                        ...
                        <div class="col-lg-6">
                            <div class="panel panel-blue">
                                ...
                                <div class="panel-body pan">
                                    <form method="post" action="daftar_acara.php">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div class="input-icon right">
                                                            ...
                                                            <input class="hidden" value="<?php $id = $_GET['id']; ?>"/>
                                                            <input name="nama" id="inputName" type="text"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div class="input-icon right">
                                                            ...
                                                            <input name="instansi" type="text" placeholder="Instansi"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="input-icon right">
                                                            ...
                                                            <input name="hp" type="text" placeholder="Nomor HP"
                                                                   class="form-control" required=""/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group mbn">
                                                <textarea name="alamat" rows="4" placeholder="Alamat"
                                                    ...
                                                    <div class="form-group">
                                                        <select name="pilih" class="form-control" required>
                                                            ...
                                                            while ($data = mysql_fetch_array($hasil)) { ?>
                                                                <option
                                                                    value="<?php echo $data['id_jenis'] ?>"> <?php echo $data['Status'] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
