    ...
    <div id="header-topbar-option-demo" class="page-header-topbar">
        ...
        <div id="wrapper">
            ...
            <nav id="sidebar" role="navigation" data-step="2"
                ...
                <div class="sidebar-collapse menu-scroll">
                    <ul id="side-menu" class="nav">
                        ...
                        <li class="active"><a href="articles.php"><i class="fa fa-send-o fa-fw">
            ...
            <div id="page-wrapper">
                ...
                <!--END FOOTER-->
                <a href="articles.php" type="submit" name="submit" class="btn btn-primary"
                ...
                <div class="col-lg-12">
                    <?php
                    $id = $_GET['id'];
                    $sql = "SELECT * FROM `tb_artikel` a join login l on a.id_user = l.id_user where id_artikel ='$id'";
