...
$sql = "select * from login l JOIN tb_artikel a on l.id_user = a.id_user";
                ...
                <div class="panel panel-blue">
                    <div class="panel-body">
                        <table class="table table-hover">
                            ...
                            <tbody>
                            <?php
                            $sql = "SELECT * FROM `tb_artikel` a join login l on a.id_user = l.id_user";
                            ...
                            while ($data = mysql_fetch_array($rslt)) { ?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-primary"
                                           href="view_articles.php?id=<?php echo $data['id_artikel'] ?>"> Read </a></td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
