    ...
    <div>
        ...
        <div id="header-topbar-option-demo" class="page-header-topbar">
            ...
            <div class="navbar-header">
                ...
                <a id="logo" href="index.php" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text">EMANSI</span><span style="display: none" class="logo-text-icon">µ</span></a></div>
            <div class="topbar-main"><a id="menu-toggle" href="#" class="hidden-xs"><i class="fa fa-bars"></i></a>
                ...
                <ul class="nav navbar navbar-top-links navbar-right mbn">
                    ...
                    if ($_SESSION['login'] == true) {
                        ?>
                        <li class="dropdown topbar-user"><a data-hover="dropdown" href="#" class="dropdown-toggle">&nbsp;<span
                                    class="hidden-xs"><?php echo $_SESSION['username']; ?></span>&nbsp;<span class="caret"></span></a>
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li><a href="add_event.php"><i class="fa fa-desktop fa-fw">
                        <div class="icon-bg bg-pink"></div>
                    </i><span class="menu-title">ADD EVENT</span></a>
                       
                    </li>
                    <li class="active"><a href="add_artikel.php"><i class="fa fa-send-o fa-fw">
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        <li><i class="fa fa-home"></i>&nbsp;<a href="dashboard_user.php">Home</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                ...
                                                                <input name="judul_artikel" id="inputName" type="text" placeholder="Judul Artikel" class="form-control" required=""/></div>
                                                        </div>
                                                    </div>
                                                    <input type="hidden" value="<?php echo $_SESSION['id_user'] ?>" name="author">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                <!-- <i class="glyphicon glyphicon-lock"></i> -->
                                                                <input value="<?php echo $_SESSION['username'] ?>" readonly id="Author" type="text" placeholder="Author" class="form-control"/></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group mbn">
                                                    <textarea name="isi_artikel" rows="8" placeholder="Artikel" class="form-control"></textarea></div>
                                                <hr />
