...
$sql = "select * from data d JOIN jenis j on d.id_jenis = j.id_jenis WHERE d.id_jenis = $pilih";
        ...
        <div id="page-wrapper">
            ...
            <form method="post" action="verifikasi.php">
                ...
                <select style="margin-left: 20px;padding-right: 100px;font-size: medium" name="pilih">
                    ...
                    while ($data = mysql_fetch_array($hasil)) { ?>
                        <option value="<?php echo $data['id_jenis'] ?>"> <?php echo $data['Status'] ?></option>
                    <?php } ?>
                </select>
            ...
            <div class="col-lg-12">
                <div class="panel panel-blue">
                    <div class="panel-heading">List Pendaftar</div>
                        ...
                        <table class="table table-hover">
                            ...
                            while ($data = mysql_fetch_array($rslt)) { ?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-primary" href="./model/ver.php?id=<?php echo $data['Nomor'] ?>" >verifikasi</a></td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
