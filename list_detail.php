    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="col-lg-12">
                <div class="panel panel-green">
                    ...
                    <div class="panel-body">
                        <table class="table table-hover">
                            ...
                            <?php
                            $id = $_GET['id'];
                            $sql = "SELECT * FROM `event` e join login l on e.id_user = l.id_user where id_event ='$id'";
                            ...
                            while ($data = mysql_fetch_array($result)) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $data['Awal_Pendaftaran'] ?></td>
                                    <td><?php echo $data['Akhir_Pendaftaran'] ?></td>
                                    <td><?php echo $data['Tanggal_Acara'] ?></td>
                                    <td><?php echo $data['Tempat'] ?></td>
                                    <td><?php
                                        $res = mysql_query("select COUNT(Nama) from data where id_event = '$id' and id_jenis = 1 ");
                                       $hasil = mysql_fetch_row($res);
                                        echo $hasil[0];
                                        ?>/<?php echo $data['kuota'] ?></td>
                ...
                <a href="list_event.php" type="submit" name="submit" class="btn btn-success" style="margin-left: 10px">
                    Back
                </a>
                <a href="daftar_acara.php?id=<?php echo $data['id_event']; ?>" type="submit" name="submit" class="btn btn-primary" style="float: right;margin-right: 20px">
                    Daftar
                </a>
                <?php } ?>
            </div>
