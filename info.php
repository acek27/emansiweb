        ...
        <nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3"
            ...
            <div class="navbar-header">
                ...
                <a id="logo" href="index.html" class="navbar-brand"><span class="fa fa-rocket"></span><span
                        class="logo-text">EMANSI</span><span style="display: none"
        ...
        <nav id="sidebar" role="navigation" data-step="2"
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="info.php"><i class="fa fa-edit fa-fw">
                                <div class="icon-bg bg-violet"></div>
                            </i><span class="menu-title">INFO</span></a>

                    </li> <li><a href="verifikasi.php"><i class="fa fa-edit fa-fw">
                                <div class="icon-bg bg-violet"></div>
                            </i><span class="menu-title">VERIFIKASI</span></a>
            ...
            <div id="chat-box" style="top: 400px">
                ...
                <div class="chat-content">
                    <ul class="chat-box-body">
                        <li>
                            <p>
                                <img src="images/avatar/128.jpg" class="avt"/><span
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        $sql = "SELECT
                                                ...
                                                FROM
                                                  `data` d
                                                JOIN EVENT
                                                  e ON d.id_event = e.id_event
                                                JOIN
                                                  login l ON l.id_user = e.id_user
                                                WHERE
                                                  l.id_user = '" . $_SESSION['id_user'] . "'";
                            ...
                            <div class="panel panel-red">
                                ...
                                <div class="panel-body">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                        <?php
                                        $sql = "SELECT * FROM `event` e join login l on e.id_user = l.id_user where l.id_user ='".$_SESSION['id_user']."'";
                                        $result = mysql_query($sql) or die (mysql_error());
                                        while ($data = mysql_fetch_array($result)) { ?>
                                            <tr>
